 ...
 * package: com.app.simpledemo.manager.imageloader
 * Date: 2017/4/25
 * user: user QuintoQin
 * 图片加载封装类，这里用的glide
 * @author 覃勤
...
public class ImageLoader {
    ...
    //设置占位图以及加载失败图片
    public static void loadCommonImageView(Context mContext, String path, ImageView mImageView, int loadingImage, int errorImageView) {
